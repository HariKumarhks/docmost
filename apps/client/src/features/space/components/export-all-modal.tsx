...
export default function ExportAllModal({ space }: ExportAllModalProps) {
  ...
  return (
    <>
      ...
      <Modal
        opened={opened}
        onClose={close}
        title="Are you sure you want to Export all Pages from this space?"
      >
        ...
        <Group justify="flex-end" mt="md">
          ...
          <Button onClick={handleExportAll} color="red">
            Confirm
          </Button>
        </Group>
      </Modal>
